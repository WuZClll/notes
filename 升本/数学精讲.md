...
3. 两向量的夹角$(0\leqslant\theta\leqslant\pi)$
...
4. 两向量的==向量积==(==叉积==、外积)
   ...
   - 向量积的计算
     ...
     \vec b_1&\vec b_2&\vec b_3\end{matrix} \right|
     \\
...
>  求余弦<img src="../MDImg/升本/高数/高数精讲课/Ⅳ.向量代数与空间解析几何/一.4-2eg.png" alt="img" style="zoom:100%;" />
>
> 求夹角  求余弦->求夹角<img src="../MDImg/升本/高数/高数精讲课/Ⅳ.向量代数与空间解析几何/一.4-3eg.png" alt="img" style="zoom:100%;" />
>
