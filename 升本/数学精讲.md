...
> 1.结论<img src="../MDImg/升本/高数/高数精讲课/Ⅱ.一元函数微分学/Ⅱ.一.1.6-2eg.png" alt="img" style="zoom:100%;" />
>
> 2.结论<img src="../MDImg/升本/高数/高数精讲课/Ⅱ.一元函数微分学/Ⅱ.一.1.6-3eg.png" alt="img" style="zoom:100%;" />
>
> 3.凑 || 结论<img src="../MDImg/升本/高数/高数精讲课/Ⅱ.一元函数微分学/Ⅱ.一.1.6-4eg.png" alt="img" style="zoom:100%;" />
...
1. $(\int_a^xf(t)dt)'=f(x)$
   ...
   > eg:
   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.21例.png)

2. $(\int_a^{\Phi(x)}f(t)dt)'=f[\Phi(x)]\Phi'(x)$

   > 类似复合函数求导
   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.22例.png)

3. $(\int_x^af(t)dt)'=-f(x)$

   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.23例.png)

4. $(\int_{\Phi(x)}^af(t)dt)'=-f[\Phi(x)]\Phi'(x)$

   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.24例.png)

5. $(\int_{\Phi_2(x)}^{\Phi_1(x)}f(t)dt)'=f[\Phi_1(x)]\Phi_1'(x)-f[\Phi_2(x)]\Phi_2'(x)$

   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.25例.png)

> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.26例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.27例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.28例.png)
...
>eg:
>![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.31例.png)
>eg:
>![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.32例.png)
...
> eg:![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.33例.png)
...
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.41例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.42例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.43例.png)
...
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.51例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.52例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.53例.png)
> eg:
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.54例.png)
...
1. 根式替换
   ...
   > eg:
   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.55例.png)
   > eg:
   > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.56例.png)
...
2. 适用范围
   ...
   - 一个函数（$对数\int_a^b\ln xdx,反三角\int_a^b \arctan xdx$）
     ...
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.61例.png)
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.62例.png)
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.63例.png)
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.64例.png)
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.65例.png)
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.66例.png)
     >
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.67例.png)
...
- 常见
  ...
  2. $S=\int_a^b(上-下)dx$
     ...
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.71例.png)
...
- 常见
  ...
  2. $S=\int_c^d(右-左)dy$
     ...
     >eg:
     >![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.72例.png)

  > 注：有时，可借助三角形求面积
  >
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.73例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.74例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.75例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.76例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.77例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.78例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.79例.png)
  > eg:
  > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.710例.png)
...
1. 平面图形绕x轴旋转一周所生成的旋转体体积
   ...
   1. $V=\pi\int_a^bf^2(x)dx$
      ...
      >  ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.81例.png)

   2. $V=\pi\int_a^b(上^2-下^2)dx$

      > ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.82例.png)
...
2. 平面图形绕y轴旋转一周所生成的旋转体的体积
   ...
   > 注：有时可借助圆锥求体积
   > eg:![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.83例.png)

> eg: 绕x
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.84例.png)
> eg: 绕x
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.85例.png)
> eg: 绕x
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.86例.png)
> eg: 绕x
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.87例.png)
> eg: 绕 x
> ![例题](C:\Users\^\Documents\aaa\markdowm笔记\MDImg\升本\高数\Ⅲ二2.88例.png)
> eg: 绕y
