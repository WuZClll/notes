...
在Linux中，命令有其通用的**格式**：``command [-options] [parameter]``
...
```sql
# 以列表形式列出当前工作目录所有文件信息(包含隐藏文件)
ls -a -l #方式1
ls -l -a #方式2
ls -al #方式3
ls -la #方式4
# 以列表形式列出根目录下所有文件信息(包含隐藏文件)
ls /la /
```
...
- 参数：被查看的文件
- 选项：-f，持续跟踪文件修改
- 选项：-num[这里的num指一个数字]，表示，查看尾部多少行，不填默认10行
